...
## Color Director
Before inventing a new palette, read `../color/teaching_curriculum.md`, `../color/combination_theory.md` and `COLOR_DIRECTOR_PROMPT.md`. Reuse `../data/color_combination_recipes.json` as starting recipes only; adapt them to the actual project and re-check contrast.
